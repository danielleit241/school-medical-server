...
namespace SchoolMedicalServer.Abstractions.IServices
{
    public interface IVaccinationResultService
    {
        ...
        Task<NotificationRequest> CreateVaccinationResult(VaccinationResultRequest request);
        ...
        Task<NotificationRequest> UpdateHealthQualifiedVaccinationResult(Guid resultId, bool status);
    }
}
