...
namespace SchoolMedicalServer.Infrastructure.Services
{
        ...
        IUserRepository userRepository) : IHealthCheckScheduleService
    {
        ...
        public async Task<NotificationScheduleResponse> CreateHealthCheckResultsByRounds(Guid scheduleId)
        {
        ...
        {
            var schedule = await healthCheckRepository.GetHealthCheckScheduleByIdAsync(request.ScheduleId);
            if (schedule == null)
                return false;
